...
def train_HT():
    ...
    with tf.variable_scope("output_projection"):
        ...
        degree2_logits = tf.layers.dense(dec_input_embed, 15)  # 15 classes for degree2
    ...
    with tf.name_scope('loss'):
        ...
        loss_d2 = tf.losses.softmax_cross_entropy(onehot_labels=tf.one_hot(y_d2, 15), logits=degree2_logits, weights=target_mask)
